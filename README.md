...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-12-18 14:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ccaed1bb-d25a-4c02-974d-4997becf75ff.git
$ cd ccaed1bb-d25a-4c02-974d-4997becf75ff
```
